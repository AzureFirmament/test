...
setup(
    ...
    data_files=[
        ...
        (f'share/{name}/paths',  glob('paths/*.csv')),
        (f'share/{name}/paths/Test_1',  glob('paths/Test_1/*.csv')),
        (f'share/{name}/paths/Test_2',  glob('paths/Test_2/*.csv')),
        (f'share/{name}/paths/Test_3',  glob('paths/Test_3/*.csv')),
        (f'share/{name}/paths/Test_4',  glob('paths/Test_4/*.csv')),
        (f'share/{name}/paths/Test_5',  glob('paths/Test_5/*.csv')),
